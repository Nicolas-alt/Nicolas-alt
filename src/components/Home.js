      ...
      <section className="section--container" id="primary">
        ...
        <div className="div--text">
          ...
          <div className="div--social">
            <a className="a--social" href="https://github.com/Nicolas-alt" target="_blank">
              <i className='bx bxl-github'></i>
            </a>
            <a className="a--social" href="https://www.linkedin.com/in/nicolas-jimenez-b20660184/"
              target="_blank">
              <i className='bx bxl-linkedin' ></i>
            </a>
            <a className="a--social" href="https://twitter.com/Nicolas35103573" target="_blank">
              <i className='bx bxl-twitter' ></i>
            </a>
            <a className="a--social" href="https://gitlab.com/Nicolas-alt" target="_blank">
              <i className='bx bxl-gitlab'></i>
            </a>
          </div>
          <a className="div--social a--projects" href="#/experiencia" >
            Mis proyectos
